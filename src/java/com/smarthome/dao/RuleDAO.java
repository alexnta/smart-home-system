...
public class RuleDAO {
    ...
    public boolean insert(RuleDTO rule) throws Exception {
        ...
        String sql = "INSERT INTO [Rule](home_id, rule_name, trigger_type, conditionjson, severity) VALUES (?, ?, ?, ?, ?)";
    ...
    public boolean update(RuleDTO rule) throws Exception {
        ...
        String sql = "UPDATE [Rule] SET rule_name=?, trigger_type=?, conditionjson=?, severity=? WHERE rule_id=?";
